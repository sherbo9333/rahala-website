...
const description = "تحكم هذه الشروط والأحكام استخدامك لموقع رسالة الإلكتروني وتعاملك مع خدماتنا.";
      ...
      <Section background="white" id="terms-content">
        <Container className="max-w-3xl">
          <LegalSection title="١. مقدمة">
            <p>
              تحدد هذه الشروط والأحكام («الشروط») القواعد الناظمة لاستخدامك لموقع رسالة للنمو الرقمي («رسالة»،
          ...
          <LegalSection title="٤. الملكية الفكرية">
            <p>
              ...
              لرسالة أو مرخّصة لها، وهي محمية بموجب أنظمة الملكية الفكرية المعمول بها. لا يجوز نسخ أو إعادة نشر أي
              من هذه المحتويات دون إذن كتابي مسبق من رسالة.
            </p>
          </LegalSection>

          <LegalSection title="٥. حدود المسؤولية">
            <p>
              يُقدَّم محتوى هذا الموقع «كما هو» دون أي ضمانات من أي نوع. لا تتحمل رسالة المسؤولية عن أي أضرار
          ...
          <LegalSection title="٦. الروابط الخارجية">
            <p>
              قد يحتوي الموقع على روابط لمواقع خارجية لا تديرها رسالة. لا تتحمل رسالة مسؤولية محتوى أو ممارسات
          ...
          <LegalSection title="٧. التعديلات على الشروط">
            <p>
              تحتفظ رسالة بحق تعديل هذه الشروط في أي وقت. يُعد استمرارك في استخدام الموقع بعد نشر أي تعديلات
