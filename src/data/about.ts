...
export const storyParagraphs = [
  "نشأت رسالة من ملاحظة بسيطة تكررت في كل قطاع تعاملنا معه: أغلب العلامات التجارية لا تفتقر إلى الجهد الرقمي، بل تفتقر إلى منظومة تُحوّل هذا الجهد إلى نمو حقيقي. حملة تسويقية هنا، موقع إلكتروني هناك، تقرير أداء لا أحد يقرأه بعمق — جهود متفرقة، كل واحدة منها قد تكون جيدة بمفردها، لكنها لا تجتمع أبدًا في اتجاه واحد.",
  "من هذه الملاحظة، لا من فكرة نظرية، بدأت رسالة. لم نُرد أن نكون وكالة تنفّذ ما يُطلب منها فحسب، بل شريكًا يسأل \"لماذا\" قبل أن يسأل \"كيف\" — يفهم النشاط التجاري والسوق أولًا، ثم يبني الاستراتيجية، ثم ينفّذ، ثم يقيس، ثم يُحسّن.",
  "اسم \"رسالة\" نفسه يعكس هذا المعنى: النمو الرقمي ليس محطة تصل إليها وتتوقف، بل رحلة مستمرة من الفهم إلى التخطيط إلى التنفيذ إلى القياس، تتكرر وتتحسن في كل دورة.",
];
